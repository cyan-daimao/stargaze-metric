...
public class MetricController {
  ...
  public Response<MetricDTO> create(@RequestBody @Valid MetricCmd cmd) {
    ...
    cmd.setUpdatedBy(UserContextHolder.getCurrentEmployee().getPassport());
  ...
  public Response<MetricSyncResultDTO> sync(@RequestBody @Valid MetricSyncRequestDTO request) {
    ...
    com.cyan.stargaze.metric.client.dto.MetricSyncRequestDTO clientReq = new com.cyan.stargaze.metric.client.dto.MetricSyncRequestDTO()
